...
!(function (t) {
      ...
      if (t.scroll) {
        ...
        do {
          ...
          if (
            ...
            (w =
              D === c
                ? ((b = N < f && ('auto' === g.overflowX || 'scroll' === g.overflowX || 'visible' === g.overflowX)),
                  M < p && ('auto' === g.overflowY || 'scroll' === g.overflowY || 'visible' === g.overflowY))
            ...
            !D ||
              ...
              (I[h].pid = setInterval(
                function () {
                  ...
                  ('function' == typeof A && 'continue' !== A.call(i, e, t, o, k, I[this.layer].el)) ||
  ...
  function bt(t, e, o, n) {
    if (t) {
      ...
      do {
        if (
          (null != e && (('>' === e[0] && t.parentNode === o && kt(t, e.substring(1))) || kt(t, e))) ||
          (n && t === o)
        )
          return t;
        if (t === o) break;
        ...
        if (t.cancelable) {
          ...
          if (
            ...
            (!dt || t.artificialBubble || pt(n, s)) &&
              !U &&
              !((/mousedown|pointerdown/.test(a) && 0 !== t.button) || i.disabled || c.isContentEditable))
          )
            if ((s = bt(s, i.draggable, n, !1))) {
              if (h !== s) {
                if (((e = At(s, i.draggable)), 'function' == typeof d)) {
                  if (d.call(this, t, s, this))
                    return Ct(o, c, 'filter', s, n, n, e), void (r && t.cancelable && t.preventDefault());
                } else if (
                  d &&
      ...
      _prepareDragStart: function (t, e, o, n) {
        ...
        o &&
          ...
          l.supportPointer
            ...
            : (wt(s, 'mouseup', r._onDrop), wt(s, 'touchend', r._onDrop), wt(s, 'touchcancel', r._onDrop)),
        ...
        if (k) {
          ...
          if (o)
            do {
              if (o[lt])
                if (
                  o[lt]._onDragOver({ clientX: k.clientX, clientY: k.clientY, target: e, rootEl: o }) &&
        ...
        if (!ht && (!dt || e.rootEl || e.artificialBubble || pt(i, r))) {
          ...
          if (
            ...
            s &&
              ...
              (c
                ? d || (t = !q.contains(U))
                : Q === this || ((this.lastPutMode = Z.checkPull(this, s, U, e)) && l.checkPut(this, s, U, e))))
          ) {
                    ...
                    'swap' === et
                      ? ('swap' !== et && (at = a.invertSwap || m),
                        (g = (function (t, e, o, n, i, r, a) {
                          ...
                          if (!r)
                            if (a && ot < c * n)
                              if ((!rt && (1 === tt ? d + (c * i) / 2 < s : s < h - (c * i) / 2) && (rt = !0), rt))
                                f = !0;
                              else {
        ...
        function z(t) {
          return (
            t &&
              ...
              s && (yt(U, Q ? Q.options.ghostClass : s.options.ghostClass, !1), yt(U, a.ghostClass, !0)),
              Q !== h && h !== mt.active ? (Q = h) : h === mt.active && (Q = null),
              o && h._animate(o, U),
              r && n && h._animate(n, r)),
            ((r === U && !U.animated) || (r === i && !r.animated)) && ($ = null),
            a.dragoverBubble || e.rootEl || r === st || (h._handleAutoScroll(e), U.parentNode[lt]._computeIsAligned(e)),
          ...
          if (
            ...
            Dt(e, 'transition', 'none'),
              Dt(
                e,
                'transform',
                'translate3d(' + (t.left - n.left) / (r || 1) + 'px,' + (t.top - n.top) / (a || 1) + 'px,0)',
              ),
              e.offsetWidth,
              Dt(e, 'transition', 'transform ' + o + 'ms' + (this.options.easing ? ' ' + this.options.easing : '')),
      ...
      _onDrop: function (t) {
        ...
        (rt = at = B = v = !1),
          ...
          t &&
            ...
            (q === V || (Q && 'clone' !== Q.lastPutMode)) && u && u.parentNode && u.parentNode.removeChild(u),
            U &&
              ...
              mt.active && ((null != n && -1 !== n) || (n = K), Ct(this, q, 'end', U, V, q, K, n, t), this.save()))),
          this._nulling();
      },
      _nulling: function () {
